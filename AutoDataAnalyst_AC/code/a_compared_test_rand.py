...
def a_main_4(data_manager):
    file_name = "../validate_accuracy/params_data_rand/logs.txt"
    data_file_name = "../validate_accuracy/params_data_rand/data.txt"
    ...
    space = {
        ...
        'max_depth': hp.choice('max_depth', [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, None]),  # 11
    ...
    best = fmin(func, space, algo=rand.suggest, max_evals=8000)
