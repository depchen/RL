...
def t_main_2(data_manager):
    file_name = "../validate_time/params_data_gp/logs.txt"
    data_file_name = "../validate_time/params_data_gp/data.txt"
    plot_data_path = "../validate_time/params_data_gp/plot_data.csv"
    ...
    data_dict_file = "./data_dict/t_gp.csv"
    ...
    rfcBO = BayesianOptimization(rfc, {'n_estimators': (1, 12.9999), 'max_depth': (1, 10.9999), 'min_samples_split': (1, 21.9999),
