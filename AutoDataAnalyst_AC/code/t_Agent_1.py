...
class LSTM:
    ...
    def __init__(self, params):
        ...
        with tf.name_scope('input_layer'):
            ...
            self.td_error = tf.placeholder(tf.float32, [1], name='td_error')  # 奖励基准值
        ...
        with tf.name_scope('loss'):
            ...
            for i in range(self.n_step):
                ...
                nlp.append(nlp_temp)
            self.loss = tf.reduce_mean(tf.reduce_sum(tf.concat(nlp, axis=1), axis=1) * self.td_error)
    ...
    def learn(self, sess, x, labels, rewards, td_error, j, writer):
