...
def a_main_3(data_manager):
    file_name = "../validate_accuracy/params_data_tpe/logs.txt"
    data_file_name = "../validate_accuracy/params_data_tpe/data.txt"
    ...
    best = fmin(func, space, algo=tpe.suggest, max_evals=8000)
