...
def t_main_3(data_manager):
    file_name = "../validate_time/params_data_tpe/logs.txt"
    data_file_name = "../validate_time/params_data_tpe/data.txt"
    data_dict_file = "./data_dict/t_tpe.csv"
    plot_data_path = "../validate_time/params_data_tpe/plot_data.csv"
    ...
    space_p = {'n_estimators': [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200],  # 12
               'max_depth': [3, 6, 9, 12, 15, 18, 21, 24, 27, 30],  # 10
    ...
    space = {
        ...
        'max_depth': hp.choice('max_depth', [3, 6, 9, 12, 15, 18, 21, 24, 27, 30]),  # 10
    ...
    best = fmin(func, space, algo=tpe.suggest, max_evals=1500)
