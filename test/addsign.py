...
class AddSign(optimizer.Optimizer):
    ...
    def __init__(self, learning_rate=1.001,t=0.0,alpha=0.01,beta=0.5, use_locking=False, name="AddSign"):
    ...
    def _apply_dense(self, grad, var):
        ...
        cd=0.5*(1+tf.cos(2.0*math.pi*0.5*self.t/1100.0))
        var_update = state_ops.assign_sub(var, lr_t*grad*(1.0+alpha_t*cd*tf.sign(grad)*tf.sign(m_t) ) )
