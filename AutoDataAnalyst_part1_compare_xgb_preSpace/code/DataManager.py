...
import RL.AutoDataAnalyst_part1_compare_xgb_preSpace.code.read_data as RD
...
class DataManager(object):
    ...
    def read_data(self, dataset_id=None):
        if dataset_id == None:
            ...
            #                   0,                  1,                      2,                  3,              4,              5,                          6
            dataset = [skdata.load_iris, skdata.load_digits, skdata.load_breast_cancer, RD.load_Adult, RD.load_Mnist, RD.load_Car_Evaluation, RD.load_litter_recognition_data_set,RD.load_epileptic_recognition]
