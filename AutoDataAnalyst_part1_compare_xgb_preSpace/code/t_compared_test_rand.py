...
def t_main_4(data_manager,file_name,data_file_name,plot_data_path,data_dict_file):
    ...
    def func(args, flag=None):
        ...
        agr_params = [max_depth, learning_rate, n_estimators, gamma, min_child_weight, subsample, colsample_bytree, colsample_bylevel, reg_alpha, reg_lambda]
    ...
    def print_test_accuracy(args, data_cv, labels_cv, data_test, labels_test):
        rfc = XGBClassifier(max_depth=args["max_depth"], learning_rate=args["learning_rate"], n_estimators=args["n_estimators"], gamma=args["gamma"],
                            min_child_weight=args['min_child_weight'], subsample=args["subsample"], colsample_bytree=args["colsample_bytree"],
                            colsample_bylevel=args["colsample_bylevel"], reg_alpha=args['reg_alpha'], reg_lambda=args["reg_lambda"],
                            nthread=-1)
